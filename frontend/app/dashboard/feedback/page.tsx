...
export default function Feedback() {
  ...
  const feedbacks = [
    { id: 1, user: "john_doe", date: "2025-03-15", message: "The new mobile app is fantastic! Much easier to use than the previous version.", read: false },
    { id: 2, user: "alice_smith", date: "2025-03-12", message: "I had trouble transferring money to an external account. Could use some improvement.", read: false },
    { id: 3, user: "robert_johnson", date: "2025-03-10", message: "Customer service was very helpful when I called about my account issue.", read: false },
    { id: 4, user: "emily_wilson", date: "2025-03-05", message: "Love the new security features! Makes me feel safer using online banking.", read: true },
    { id: 5, user: "michael_brown", date: "2025-03-01", message: "The website is much faster now after the recent update. Great job!", read: true },
  ];
